...
export const projects: Project[] = [
    {
        ...
        links: [
            { label: 'Play Game', url: 'https://rizqhfdz.itch.io/endless-runner-dda-research', icon: 'sports_esports', isPrimary: true },
    ...
    },
    {
        ...
        links: [
            { label: 'Visit Website', url: 'http://localhost:3000', icon: 'web', isPrimary: true },
            { label: 'GitHub Repository', url: 'https://github.com/Rizqihafidz', icon: 'code', isPrimary: false },
        ],
        highlights: [
